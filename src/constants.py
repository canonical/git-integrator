...
SSH_PASSPHRASE_SECRET_CONFIG = "ssh_passphrase_secret"
...
INVALID_SSH_PASSPHRASE_SECRET_MESSAGE = "SSH passphrase secret not valid"
MISSING_SSH_PASSPHRASE_IN_SECRET_MESSAGE = "Missing SSH passphrase in secret"
